...
#ifndef NERVA_LIBWALLET2_API_C_H
#define NERVA_LIBWALLET2_API_C_H
...
//     MAINNET = 0,
extern ADDAPI const int NERVA_NetworkType_MAINNET;
//     TESTNET,
extern ADDAPI const int NERVA_NetworkType_TESTNET;
//     STAGENET
extern ADDAPI const int NERVA_NetworkType_STAGENET;
// };
//     namespace Utils {
...
//     enum Status {
//         Status_Ok,
extern ADDAPI const int NERVA_PendingTransactionStatus_Ok;
//         Status_Error,
extern ADDAPI const int NERVA_PendingTransactionStatus_Error;
//         Status_Critical
extern ADDAPI const int NERVA_PendingTransactionStatus_Critical;
//     };
//     enum Priority {
//         Priority_Default = 0,
extern ADDAPI const int NERVA_Priority_Default;
//         Priority_Low = 1,
extern ADDAPI const int NERVA_Priority_Low;
//         Priority_Medium = 2,
extern ADDAPI const int NERVA_Priority_Medium;
//         Priority_High = 3,
extern ADDAPI const int NERVA_Priority_High;
//         Priority_Last
extern ADDAPI const int NERVA_Priority_Last;
//     };
//     virtual ~PendingTransaction() = 0;
//     virtual int status() const = 0;
extern ADDAPI int NERVA_PendingTransaction_status(void* pendingTx_ptr);
...
extern ADDAPI uint64_t NERVA_PendingTransaction_dust(void* pendingTx_ptr);
//     virtual uint64_t fee() const = 0;
extern ADDAPI uint64_t NERVA_PendingTransaction_fee(void* pendingTx_ptr);
//     virtual std::vector<std::string> txid() const = 0;
extern ADDAPI const char* NERVA_PendingTransaction_txid(void* pendingTx_ptr, const char* separator);
//     virtual uint64_t txCount() const = 0;
extern ADDAPI uint64_t NERVA_PendingTransaction_txCount(void* pendingTx_ptr);
//     virtual std::vector<uint32_t> subaddrAccount() const = 0;
extern ADDAPI const char* NERVA_PendingTransaction_subaddrAccount(void* pendingTx_ptr, const char* separator);
//     virtual std::vector<std::set<uint32_t>> subaddrIndices() const = 0;
extern ADDAPI const char* NERVA_PendingTransaction_subaddrIndices(void* pendingTx_ptr, const char* separator);
//     virtual std::string multisigSignData() = 0;
extern ADDAPI const char* NERVA_PendingTransaction_multisigSignData(void* pendingTx_ptr);
//     virtual void signMultisigTx() = 0;
extern ADDAPI void NERVA_PendingTransaction_signMultisigTx(void* pendingTx_ptr);
...
//     enum Status {
//         Status_Ok,
extern ADDAPI const int NERVA_UnsignedTransactionStatus_Ok;
//         Status_Error,
extern ADDAPI const int NERVA_UnsignedTransactionStatus_Error;
//         Status_Critical
extern ADDAPI const int NERVA_UnsignedTransactionStatus_Critical;
//     };
//     virtual ~UnsignedTransaction() = 0;
//     virtual int status() const = 0;
extern ADDAPI int NERVA_UnsignedTransaction_status(void* unsignedTx_ptr);
//     virtual std::string errorString() const = 0;
extern ADDAPI const char* NERVA_UnsignedTransaction_errorString(void* unsignedTx_ptr);
//     virtual std::vector<uint64_t> amount() const = 0;
extern ADDAPI const char* NERVA_UnsignedTransaction_amount(void* unsignedTx_ptr, const char* separator);
...
extern ADDAPI const char* NERVA_UnsignedTransaction_paymentId(void* unsignedTx_ptr, const char* separator);
...
//     enum Direction {
//         Direction_In,
extern ADDAPI const int NERVA_TransactionInfoDirection_In;
//         Direction_Out
extern ADDAPI const int NERVA_TransactionInfoDirection_Out;
//     };
//     struct Transfer {
...
extern ADDAPI int NERVA_TransactionInfo_direction(void* txInfo_ptr);
//     virtual bool isPending() const = 0;
extern ADDAPI bool NERVA_TransactionInfo_isPending(void* txInfo_ptr);
...
//     virtual uint64_t fee() const = 0;
extern ADDAPI uint64_t NERVA_TransactionInfo_fee(void* txInfo_ptr);
...
extern ADDAPI uint32_t NERVA_TransactionInfo_subaddrAccount(void* txInfo_ptr);
//     virtual std::string label() const = 0;
extern ADDAPI const char* NERVA_TransactionInfo_label(void* txInfo_ptr);
//     virtual uint64_t confirmations() const = 0;
extern ADDAPI uint64_t NERVA_TransactionInfo_confirmations(void* txInfo_ptr);
//     virtual uint64_t unlockTime() const = 0;
extern ADDAPI uint64_t NERVA_TransactionInfo_unlockTime(void* txInfo_ptr);
//     virtual std::string hash() const = 0;
extern ADDAPI const char* NERVA_TransactionInfo_hash(void* txInfo_ptr);
//     virtual std::time_t timestamp() const = 0;
extern ADDAPI uint64_t NERVA_TransactionInfo_timestamp(void* txInfo_ptr);
//     virtual std::string paymentId() const = 0;
extern ADDAPI const char* NERVA_TransactionInfo_paymentId(void* txInfo_ptr);
//     virtual const std::vector<Transfer> & transfers() const = 0;
extern ADDAPI int NERVA_TransactionInfo_transfers_count(void* txInfo_ptr);
extern ADDAPI uint64_t NERVA_TransactionInfo_transfers_amount(void* txInfo_ptr, int index);
extern ADDAPI const char* NERVA_TransactionInfo_transfers_address(void* txInfo_ptr, int address);
// };
// struct TransactionHistory
// {
//     virtual ~TransactionHistory() = 0;
//     virtual int count() const = 0;
extern ADDAPI int NERVA_TransactionHistory_count(void* txHistory_ptr);
//     virtual TransactionInfo * transaction(int index)  const = 0;
extern ADDAPI void* NERVA_TransactionHistory_transaction(void* txHistory_ptr, int index);
//     virtual TransactionInfo * transaction(const std::string &id) const = 0;
extern ADDAPI void* NERVA_TransactionHistory_transactionById(void* txHistory_ptr, const char* id);
...
//     enum ErrorCode {
//         Status_Ok,
extern ADDAPI const int NERVA_AddressBookErrorCodeStatus_Ok;
//         General_Error,
extern ADDAPI const int NERVA_AddressBookErrorCodeGeneral_Error;
//         Invalid_Address,
extern ADDAPI const int NERVA_AddressBookErrorCodeInvalid_Address;
//         Invalid_Payment_Id
extern ADDAPI const int NERVA_AddressBookErrorCodeInvalidPaymentId;
//     };
...
// public:
//     std::string extra;
extern ADDAPI const char* NERVA_SubaddressRow_extra(void* subaddressRow_ptr);
//     std::string getAddress() const {return m_address;}
extern ADDAPI const char* NERVA_SubaddressRow_getAddress(void* subaddressRow_ptr);
//     std::string getLabel() const {return m_label;}
extern ADDAPI const char* NERVA_SubaddressRow_getLabel(void* subaddressRow_ptr);
//     std::size_t getRowId() const {return m_rowId;}
extern ADDAPI size_t NERVA_SubaddressRow_getRowId(void* subaddressRow_ptr);
// };
...
extern ADDAPI int NERVA_Subaddress_getAll_size(void* subaddress_ptr);
extern ADDAPI void* NERVA_Subaddress_getAll_byIndex(void* subaddress_ptr, int index);
//     virtual void addRow(uint32_t accountIndex, const std::string &label) = 0;
extern ADDAPI void NERVA_Subaddress_addRow(void* subaddress_ptr, uint32_t accountIndex, const char* label);
//     virtual void setLabel(uint32_t accountIndex, uint32_t addressIndex, const std::string &label) = 0;
extern ADDAPI void NERVA_Subaddress_setLabel(void* subaddress_ptr, uint32_t accountIndex, uint32_t addressIndex, const char* label);
//     virtual void refresh(uint32_t accountIndex) = 0;
extern ADDAPI void NERVA_Subaddress_refresh(void* subaddress_ptr, uint32_t accountIndex);
// };
...
// public:
//     std::string extra;
extern ADDAPI const char* NERVA_SubaddressAccountRow_extra(void* subaddressAccountRow_ptr);
//     std::string getAddress() const {return m_address;}
extern ADDAPI const char* NERVA_SubaddressAccountRow_getAddress(void* subaddressAccountRow_ptr);
//     std::string getLabel() const {return m_label;}
extern ADDAPI const char* NERVA_SubaddressAccountRow_getLabel(void* subaddressAccountRow_ptr);
//     std::string getBalance() const {return m_balance;}
extern ADDAPI const char* NERVA_SubaddressAccountRow_getBalance(void* subaddressAccountRow_ptr);
//     std::string getUnlockedBalance() const {return m_unlockedBalance;}
extern ADDAPI const char* NERVA_SubaddressAccountRow_getUnlockedBalance(void* subaddressAccountRow_ptr);
//     std::size_t getRowId() const {return m_rowId;}
extern ADDAPI size_t NERVA_SubaddressAccountRow_getRowId(void* subaddressAccountRow_ptr);
// };
...
extern ADDAPI int NERVA_SubaddressAccount_getAll_size(void* subaddressAccount_ptr);
extern ADDAPI void* NERVA_SubaddressAccount_getAll_byIndex(void* subaddressAccount_ptr, int index);
//     virtual void addRow(const std::string &label) = 0;
extern ADDAPI void NERVA_SubaddressAccount_addRow(void* subaddressAccount_ptr, const char* label);
//     virtual void setLabel(uint32_t accountIndex, const std::string &label) = 0;
extern ADDAPI void NERVA_SubaddressAccount_setLabel(void* subaddressAccount_ptr, uint32_t accountIndex, const char* label);
//     virtual void refresh() = 0;
extern ADDAPI void NERVA_SubaddressAccount_refresh(void* subaddressAccount_ptr);
// };
...
//     bool isMultisig;
extern ADDAPI bool NERVA_MultisigState_isMultisig(void* multisigState_ptr);
//     bool isReady;
extern ADDAPI bool NERVA_MultisigState_isReady(void* multisigState_ptr);
//     uint32_t threshold;
extern ADDAPI uint32_t NERVA_MultisigState_threshold(void* multisigState_ptr);
//     uint32_t total;
extern ADDAPI uint32_t NERVA_MultisigState_total(void* multisigState_ptr);
// };
...
extern ADDAPI bool NERVA_DeviceProgress_progress(void* deviceProgress_ptr);
//     virtual bool indeterminate() const { return m_indeterminate; }
extern ADDAPI bool NERVA_DeviceProgress_indeterminate(void* deviceProgress_ptr);
...
//     enum Device {
//         Device_Software = 0,
extern ADDAPI const int NERVA_WalletDevice_Software;
//         Device_Ledger = 1,
extern ADDAPI const int NERVA_WalletDevice_Ledger;
//         Device_Trezor = 2
extern ADDAPI const int NERVA_WalletDevice_Trezor;
//     };
//     enum Status {
//         Status_Ok,
extern ADDAPI const int NERVA_WalletStatus_Ok;
//         Status_Error,
extern ADDAPI const int NERVA_WalletStatus_Error;
//         Status_Critical
extern ADDAPI const int NERVA_WalletStatus_Critical;
//     };
//     enum ConnectionStatus {
//         ConnectionStatus_Disconnected,
extern ADDAPI const int NERVA_WalletConnectionStatus_Disconnected;
//         ConnectionStatus_Connected,
extern ADDAPI const int NERVA_WalletConnectionStatus_Connected;
//         ConnectionStatus_WrongVersion
extern ADDAPI const int NERVA_WalletConnectionStatus_WrongVersion;
//     };
//    enum BackgroundSyncType {
//        BackgroundSync_Off = 0,
extern ADDAPI const int NERVA_WalletBackgroundSync_Off;
//        BackgroundSync_ReusePassword = 1,
extern ADDAPI const int NERVA_WalletBackgroundSync_ReusePassword;
//        BackgroundSync_CustomPassword = 2
extern ADDAPI const int NERVA_WalletBackgroundSync_CustomPassword;
//    };
//     virtual ~Wallet() = 0;
...
extern ADDAPI void NERVA_Wallet_setSeedLanguage(void* wallet_ptr, const char* arg);
//     virtual int status() const = 0;
extern ADDAPI int NERVA_Wallet_status(void* wallet_ptr);
//     virtual std::string errorString() const = 0;
extern ADDAPI const char* NERVA_Wallet_errorString(void* wallet_ptr);
...
extern ADDAPI bool NERVA_Wallet_setDevicePassphrase(void* wallet_ptr, const char* passphrase);
//     virtual std::string address(uint32_t accountIndex = 0, uint32_t addressIndex = 0) const = 0;
extern ADDAPI const char* NERVA_Wallet_address(void* wallet_ptr, uint64_t accountIndex, uint64_t addressIndex);
//     std::string mainAddress() const { return address(0, 0); }
//     virtual std::string path() const = 0;
extern ADDAPI const char* NERVA_Wallet_path(void* wallet_ptr);
//     virtual NetworkType nettype() const = 0;
extern ADDAPI int NERVA_Wallet_nettype(void* wallet_ptr);
...
extern ADDAPI uint8_t NERVA_Wallet_useForkRules(void* wallet_ptr, uint8_t version, int64_t early_blocks);
//     virtual std::string integratedAddress(const std::string &payment_id) const = 0;
extern ADDAPI const char* NERVA_Wallet_integratedAddress(void* wallet_ptr, const char* payment_id);
//     virtual std::string secretViewKey() const = 0;
extern ADDAPI const char* NERVA_Wallet_secretViewKey(void* wallet_ptr);
//     virtual std::string publicViewKey() const = 0;
extern ADDAPI const char* NERVA_Wallet_publicViewKey(void* wallet_ptr);
//     virtual std::string secretSpendKey() const = 0;
extern ADDAPI const char* NERVA_Wallet_secretSpendKey(void* wallet_ptr);
//     virtual std::string publicSpendKey() const = 0;
extern ADDAPI const char* NERVA_Wallet_publicSpendKey(void* wallet_ptr);
...
extern ADDAPI const char* NERVA_Wallet_filename(void* wallet_ptr);
...
extern ADDAPI void NERVA_Wallet_setRefreshFromBlockHeight(void* wallet_ptr, uint64_t refresh_from_block_height);
//     virtual uint64_t getRefreshFromBlockHeight() const = 0;
extern ADDAPI uint64_t NERVA_Wallet_getRefreshFromBlockHeight(void* wallet_ptr);
//     virtual void setRecoveringFromSeed(bool recoveringFromSeed) = 0;
extern ADDAPI void NERVA_Wallet_setRecoveringFromSeed(void* wallet_ptr, bool recoveringFromSeed);
//     virtual void setRecoveringFromDevice(bool recoveringFromDevice) = 0;
extern ADDAPI void NERVA_Wallet_setRecoveringFromDevice(void* wallet_ptr, bool recoveringFromDevice);
//     virtual void setSubaddressLookahead(uint32_t major, uint32_t minor) = 0;
extern ADDAPI void NERVA_Wallet_setSubaddressLookahead(void* wallet_ptr, uint32_t major, uint32_t minor);
//     virtual bool connectToDaemon() = 0;
extern ADDAPI bool NERVA_Wallet_connectToDaemon(void* wallet_ptr);
//     virtual ConnectionStatus connected() const = 0;
extern ADDAPI int NERVA_Wallet_connected(void* wallet_ptr);
//     virtual void setTrustedDaemon(bool arg) = 0;
extern ADDAPI void NERVA_Wallet_setTrustedDaemon(void* wallet_ptr, bool arg);
...
extern ADDAPI uint64_t NERVA_Wallet_unlockedBalance(void* wallet_ptr, uint32_t accountIndex);
...
extern ADDAPI uint64_t NERVA_Wallet_approximateBlockChainHeight(void* wallet_ptr);
//     virtual uint64_t estimateBlockChainHeight() const = 0;
extern ADDAPI uint64_t NERVA_Wallet_estimateBlockChainHeight(void* wallet_ptr);
//     virtual uint64_t daemonBlockChainHeight() const = 0;
extern ADDAPI uint64_t NERVA_Wallet_daemonBlockChainHeight(void* wallet_ptr);
//     virtual uint64_t daemonBlockChainTargetHeight() const = 0;
extern ADDAPI uint64_t NERVA_Wallet_daemonBlockChainTargetHeight(void* wallet_ptr);
//     virtual bool synchronized() const = 0;
extern ADDAPI bool NERVA_Wallet_synchronized(void* wallet_ptr);
//     static std::string displayAmount(uint64_t amount);
extern ADDAPI const char* NERVA_Wallet_displayAmount(uint64_t amount);
//     static uint64_t amountFromString(const std::string &amount);
extern ADDAPI uint64_t NERVA_Wallet_amountFromString(const char* amount);
//     static uint64_t amountFromDouble(double amount);
extern ADDAPI uint64_t NERVA_Wallet_amountFromDouble(double amount);
//     static std::string genPaymentId();
extern ADDAPI const char* NERVA_Wallet_genPaymentId();
//     static bool paymentIdValid(const std::string &paiment_id);
extern ADDAPI bool NERVA_Wallet_paymentIdValid(const char* paiment_id);
//     static bool addressValid(const std::string &str, NetworkType nettype);
extern ADDAPI bool NERVA_Wallet_addressValid(const char* str, int nettype);
//     static bool addressValid(const std::string &str, bool testnet)          // deprecated
//     {
//         return addressValid(str, testnet ? TESTNET : MAINNET);
//     }
extern ADDAPI bool NERVA_Wallet_keyValid(const char* secret_key_string, const char* address_string, bool isViewKey, int nettype);
extern ADDAPI const char* NERVA_Wallet_keyValid_error(const char* secret_key_string, const char* address_string, bool isViewKey, int nettype);
...
extern ADDAPI const char* NERVA_Wallet_paymentIdFromAddress(const char* strarg, int nettype);
...
extern ADDAPI uint64_t NERVA_Wallet_maximumAllowedAmount();
...
extern ADDAPI void NERVA_Wallet_init3(void* wallet_ptr, const char* argv0, const char* default_log_base_name, const char* log_path, bool console);
...
extern ADDAPI bool NERVA_Wallet_refresh(void* wallet_ptr);
//     virtual void refreshAsync() = 0;
extern ADDAPI void NERVA_Wallet_refreshAsync(void* wallet_ptr);
//     virtual bool rescanBlockchain() = 0;
extern ADDAPI bool NERVA_Wallet_rescanBlockchain(void* wallet_ptr);
//     virtual void rescanBlockchainAsync() = 0;
extern ADDAPI void NERVA_Wallet_rescanBlockchainAsync(void* wallet_ptr);
//     virtual void setAutoRefreshInterval(int millis) = 0;
extern ADDAPI void NERVA_Wallet_setAutoRefreshInterval(void* wallet_ptr, int millis);
//     virtual int autoRefreshInterval() const = 0;
extern ADDAPI int NERVA_Wallet_autoRefreshInterval(void* wallet_ptr);
//     virtual void addSubaddressAccount(const std::string& label) = 0;
extern ADDAPI void NERVA_Wallet_addSubaddressAccount(void* wallet_ptr, const char* label);
//     virtual size_t numSubaddressAccounts() const = 0;
extern ADDAPI size_t NERVA_Wallet_numSubaddressAccounts(void* wallet_ptr);
//     virtual size_t numSubaddresses(uint32_t accountIndex) const = 0;
extern ADDAPI size_t NERVA_Wallet_numSubaddresses(void* wallet_ptr, uint32_t accountIndex);
//     virtual void addSubaddress(uint32_t accountIndex, const std::string& label) = 0;
extern ADDAPI void NERVA_Wallet_addSubaddress(void* wallet_ptr, uint32_t accountIndex, const char* label);
//     virtual std::string getSubaddressLabel(uint32_t accountIndex, uint32_t addressIndex) const = 0;
extern ADDAPI const char* NERVA_Wallet_getSubaddressLabel(void* wallet_ptr, uint32_t accountIndex, uint32_t addressIndex);
//     virtual void setSubaddressLabel(uint32_t accountIndex, uint32_t addressIndex, const std::string &label) = 0;
extern ADDAPI void NERVA_Wallet_setSubaddressLabel(void* wallet_ptr, uint32_t accountIndex, uint32_t addressIndex, const char* label);
//     virtual MultisigState multisig() const = 0;
extern ADDAPI void* NERVA_Wallet_multisig(void* wallet_ptr);
//     virtual std::string getMultisigInfo() const = 0;
extern ADDAPI const char* NERVA_Wallet_getMultisigInfo(void* wallet_ptr);
...
extern ADDAPI size_t NERVA_Wallet_importMultisigImages(void* wallet_ptr, const char* info, const char* info_separator);
//     virtual bool hasMultisigPartialKeyImages() const = 0;
extern ADDAPI size_t NERVA_Wallet_hasMultisigPartialKeyImages(void* wallet_ptr);
//     virtual PendingTransaction*  restoreMultisigTransaction(const std::string& signData) = 0;
extern ADDAPI void* NERVA_Wallet_restoreMultisigTransaction(void* wallet_ptr, const char* signData);
...
extern ADDAPI void* NERVA_Wallet_createTransactionMultDest(void* wallet_ptr, const char* dst_addr_list, const char* dst_addr_list_separator, const char* payment_id,
...
extern ADDAPI void* NERVA_Wallet_createTransaction(void* wallet_ptr, const char* dst_addr, const char* payment_id,
...
extern ADDAPI const char* NERVA_Wallet_getCacheAttribute(void* wallet_ptr, const char* key);
//     virtual bool setUserNote(const std::string &txid, const std::string &note) = 0;
extern ADDAPI bool NERVA_Wallet_setUserNote(void* wallet_ptr, const char* txid, const char* note);
//     virtual std::string getUserNote(const std::string &txid) const = 0;
extern ADDAPI const char* NERVA_Wallet_getUserNote(void* wallet_ptr, const char* txid);
//     virtual std::string getTxKey(const std::string &txid) const = 0;
extern ADDAPI const char* NERVA_Wallet_getTxKey(void* wallet_ptr, const char* txid);
...
extern ADDAPI void NERVA_Wallet_segregatePreForkOutputs(void* wallet_ptr, bool segregate);
//     virtual void segregationHeight(uint64_t height) = 0;
extern ADDAPI void NERVA_Wallet_segregationHeight(void* wallet_ptr, uint64_t height);
//     virtual void keyReuseMitigation2(bool mitigation) = 0;
extern ADDAPI void NERVA_Wallet_keyReuseMitigation2(void* wallet_ptr, bool mitigation);
//     virtual bool lightWalletLogin(bool &isNewWallet) const = 0;
//     virtual bool lightWalletImportWalletRequest(std::string &payment_id, uint64_t &fee, bool &new_request, bool &request_fulfilled, std::string &payment_address, std::string &status) = 0;
//     virtual bool lockKeysFile() = 0;
extern ADDAPI bool NERVA_Wallet_lockKeysFile(void* wallet_ptr);
//     virtual bool unlockKeysFile() = 0;
extern ADDAPI bool NERVA_Wallet_unlockKeysFile(void* wallet_ptr);
//     virtual bool isKeysFileLocked() = 0;
extern ADDAPI bool NERVA_Wallet_isKeysFileLocked(void* wallet_ptr);
//     virtual Device getDeviceType() const = 0;
extern ADDAPI int NERVA_Wallet_getDeviceType(void* wallet_ptr);
//     virtual uint64_t coldKeyImageSync(uint64_t &spent, uint64_t &unspent) = 0;
extern ADDAPI uint64_t NERVA_Wallet_coldKeyImageSync(void* wallet_ptr, uint64_t spent, uint64_t unspent);
...
extern ADDAPI void* NERVA_WalletManager_createWallet(void* wm_ptr, const char* path, const char* password, const char* language, int networkType);
...
extern ADDAPI void* NERVA_WalletManager_openWallet(void* wm_ptr, const char* path, const char* password, int networkType);
...
extern ADDAPI void* NERVA_WalletManager_recoveryWallet(void* wm_ptr, const char* path, const char* password, const char* mnemonic, int networkType, uint64_t restoreHeight, uint64_t kdfRounds, const char* seedOffset);
...
extern ADDAPI void* NERVA_WalletManager_createWalletFromKeys(void* wm_ptr, const char* path, const char* password, const char* language, int nettype, uint64_t restoreHeight, const char* addressString, const char* viewKeyString, const char* spendKeyString, uint64_t kdf_rounds);
...
extern ADDAPI void* NERVA_WalletManager_createWalletFromDevice(void* wm_ptr, const char* path, const char* password, int nettype, const char* deviceName, uint64_t restoreHeight, const char* subaddressLookahead, const char* viewKeyString, const char* spendKeyString, uint64_t kdf_rounds);
...
extern ADDAPI bool NERVA_WalletManager_walletExists(void* wm_ptr, const char* path);
//     virtual bool verifyWalletPassword(const std::string &keys_file_name, const std::string &password, bool no_spend_key, uint64_t kdf_rounds = 1) const = 0;
extern ADDAPI bool NERVA_WalletManager_verifyWalletPassword(void* wm_ptr, const char* keys_file_name, const char* password, bool no_spend_key, uint64_t kdf_rounds);
...
extern ADDAPI int NERVA_WalletManager_queryWalletDevice(void* wm_ptr, const char* keys_file_name, const char* password, uint64_t kdf_rounds);
//     virtual std::vector<std::string> findWallets(const std::string &path) = 0;
extern ADDAPI const char* NERVA_WalletManager_findWallets(void* wm_ptr, const char* path, const char* separator);
//     virtual std::string errorString() const = 0;
extern ADDAPI const char* NERVA_WalletManager_errorString(void* wm_ptr);
//     virtual void setDaemonAddress(const std::string &address) = 0;
extern ADDAPI void NERVA_WalletManager_setDaemonAddress(void* wm_ptr, const char* address);
//     virtual bool connected(uint32_t *version = NULL) = 0;
//     virtual uint64_t blockchainHeight() = 0;
extern ADDAPI uint64_t NERVA_WalletManager_blockchainHeight(void* wm_ptr);
//     virtual uint64_t blockchainTargetHeight() = 0;
extern ADDAPI uint64_t NERVA_WalletManager_blockchainTargetHeight(void* wm_ptr);
//     virtual uint64_t networkDifficulty() = 0;
extern ADDAPI uint64_t NERVA_WalletManager_networkDifficulty(void* wm_ptr);
//     virtual double miningHashRate() = 0;
extern ADDAPI double NERVA_WalletManager_miningHashRate(void* wm_ptr);
//     virtual uint64_t blockTarget() = 0;
extern ADDAPI uint64_t NERVA_WalletManager_blockTarget(void* wm_ptr);
//     virtual bool isMining() = 0;
extern ADDAPI bool NERVA_WalletManager_isMining(void* wm_ptr);
//     virtual bool startMining(const std::string &address, uint32_t threads = 1, bool background_mining = false, bool ignore_battery = true) = 0;
extern ADDAPI bool NERVA_WalletManager_startMining(void* wm_ptr, const char* address, uint32_t threads, bool backgroundMining, bool ignoreBattery);
//     virtual bool stopMining() = 0;
extern ADDAPI bool NERVA_WalletManager_stopMining(void* wm_ptr, const char* address);
//     virtual std::string resolveOpenAlias(const std::string &address, bool &dnssec_valid) const = 0;
extern ADDAPI const char* NERVA_WalletManager_resolveOpenAlias(void* wm_ptr, const char* address, bool dnssec_valid);
...
extern ADDAPI const int NERVA_LogLevel_0;
extern ADDAPI const int NERVA_LogLevel_1;
extern ADDAPI const int NERVA_LogLevel_2;
extern ADDAPI const int NERVA_LogLevel_3;
extern ADDAPI const int NERVA_LogLevel_4;
extern ADDAPI const int NERVA_LogLevel_Min;
extern ADDAPI const int NERVA_LogLevel_Max;
...
extern ADDAPI void* NERVA_WalletManagerFactory_getWalletManager();
//     static void setLogLevel(int level);
extern ADDAPI void NERVA_WalletManagerFactory_setLogLevel(int level);
//     static void setLogCategories(const std::string &categories);
extern ADDAPI void NERVA_WalletManagerFactory_setLogCategories(const char* categories);
// };
// }

extern ADDAPI void NERVA_DEBUG_test0();
extern ADDAPI bool NERVA_DEBUG_test1(bool x);
extern ADDAPI int NERVA_DEBUG_test2(int x);
extern ADDAPI uint64_t NERVA_DEBUG_test3(uint64_t x);
extern ADDAPI void* NERVA_DEBUG_test4(uint64_t x);
extern ADDAPI const char* NERVA_DEBUG_test5();
extern ADDAPI const char* NERVA_DEBUG_test5_std();
extern ADDAPI bool NERVA_DEBUG_isPointerNull(void* wallet_ptr);

// cake world

extern ADDAPI void* NERVA_cw_getWalletListener(void* wallet_ptr);
extern ADDAPI void NERVA_cw_WalletListener_resetNeedToRefresh(void* cw_walletListener_ptr);
extern ADDAPI bool NERVA_cw_WalletListener_isNeedToRefresh(void* cw_walletListener_ptr);
extern ADDAPI bool NERVA_cw_WalletListener_isNewTransactionExist(void* cw_walletListener_ptr);
extern ADDAPI void NERVA_cw_WalletListener_resetIsNewTransactionExist(void* cw_walletListener_ptr);
extern ADDAPI uint64_t NERVA_cw_WalletListener_height(void* cw_walletListener_ptr);

extern ADDAPI void NERVA_free(void* ptr);

extern ADDAPI const char* NERVA_checksum_wallet2_api_c_h();
extern ADDAPI const char* NERVA_checksum_wallet2_api_c_cpp();
extern ADDAPI const char* NERVA_checksum_wallet2_api_c_exp();

#ifdef __cplusplus
}
#endif

#endif // NERVA_LIBWALLET2_API_C_H
